...
class CallerProfile extends StatefulWidget {
  CallerProfile({
    this.userId,
    this.image,
    this.name,
  ...
  @override
  _CallerProfile createState() => _CallerProfile();
}

class _CallerProfile extends State<CallerProfile> {
  bool isShow = true;
  int status =0;
  @override
  void initState() {
                    ...
                    Stack(
                      children: [
                        Container(
                          ...
                          decoration:widget.coverphoto != "" ? BoxDecoration(image: DecorationImage(image: NetworkImage(widget.coverphoto??""), fit: BoxFit.cover))
                              :BoxDecoration(image: DecorationImage(image: ExactAssetImage("images/profile.jpeg"), fit: BoxFit.fill)),
                        ),
                        widget.isBrodcaster!?
                        Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            ...
                            child:GestureDetector(
                              onTap: (){
                                if(!widget.broadcaster_mute!) {
                                  setState(() {
                                    widget.muted = !widget.muted!;
                                  });
                                  FirestoreServices.joinUserMuteUnmute(
                                      widget.channelName??"", widget.muted!,
                                      widget.userId??"");
                                }else{
                                  Fluttertoast.showToast(msg: "Sorry! You can't unmute to yourself");
                                }
                              },
                              child:Container(
                                padding: const EdgeInsets.all(5.0),
                                ...
                                showModalBottomSheet(
                                    ...
                                    builder: (context) {
                                      return Gift_Model(
                                        ...
                                        viewer: widget.viewerModel,
                                        broadcastUser: widget.broadcastUser,
                                      );
                                    });
                              },
                              icon: Image.asset(
                                  "images/Gift.png")):Container(),
                          SizedBox(
                            width: 8,
                          ),
                          widget.isBrodcaster == true?Expanded(
                          ...
                          Expanded(
                              ...
                              child:GestureDetector(
                                onTap: (){
                                  widget.callEnd!();
                                  FirestoreServices.joinUserRemove(widget.channelName??"",widget.userId??"");
                                  Navigator.pop(context);
                                },
                                child: Container(
                                  padding: const EdgeInsets.all(5.0),
