...
class GoLiveLanding extends StatefulWidget {
  @override
  _GoLiveLandingState createState() => _GoLiveLandingState();
}

class _GoLiveLandingState extends State<GoLiveLanding> {
  int activeIdx = 2;
                            ...
                            onPressed: () async {
                              if (!showCountdown) {
                                ...
                                if (activeIdx != 3) {
                                  ...
                                  await FirestoreServices.createNewLive(liveId??"", _title.text, context, activeIdx, seats);
                                }
                              } else {}
                            },
